...
// Root file: contracts/DePayPaymentProcessorV1Uniswap01.sol
...
contract DePayPaymentProcessorV1Uniswap01 {
  ...
  function process(
    ...
    // Make sure swapping the token within the payment processor contract is approved on the Uniswap router.
    if( 
      path[0] != ZERO &&
